...
nhn.husky.SE2M_AttachQuickPhoto = jindo.$Class({		
	...
	$ON_ATTACHPHOTO_OPEN_WINDOW : function(){			
        ...
        this.htPopupOption.sProperties = "left="+(screen.width-640)/2+", top="+(screen.height-459)/2+",width=390,height=329,scrollbars=yes,location=no,status=0,resizable=no";
	...
	makePopupURL : function(){
		var sPopupUrl = "/common/image/UploadPage.do?id="+this.oApp.elPlaceHolder.id;
		return sPopupUrl;
	},
