...
{
    public class Lct_Recsroom : Controller {
        private readonly ILogger<Lct_Recsroom> _logger;
        private readonly AppSoftDbContext _context;
        private readonly CommonDao _commonDao;

        public Lct_Recsroom(ILogger<Lct_Recsroom> logger, AppSoftDbContext context) {
            _logger = logger;
            _context = context;
