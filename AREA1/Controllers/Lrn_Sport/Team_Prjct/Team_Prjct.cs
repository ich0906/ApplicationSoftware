...
namespace AREA1.Controllers.Lrn_Sport.Team_Prjct
{
    public class Team_Prjct : Controller {
        private readonly ILogger<Team_Prjct> _logger;
        private readonly AppSoftDbContext _context;
        private readonly CommonDao _commonDao;

        public Team_Prjct(ILogger<Team_Prjct> logger, AppSoftDbContext context) {
            _logger = logger;
            _context = context;
