...
namespace AREA1.Controllers.Lrn_Sport.Online_Test_Apyexm
{
    public class Online_Test_Apyexm : Controller {
        private readonly ILogger<Online_Test_Apyexm> _logger;
        private readonly AppSoftDbContext _context;
        private readonly CommonDao _commonDao;

        public Online_Test_Apyexm(ILogger<Online_Test_Apyexm> logger, AppSoftDbContext context) {
            _logger = logger;
            _context = context;
