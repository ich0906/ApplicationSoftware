...
{
    public class Task_Prsentr : Controller {
        private readonly ILogger<Task_Prsentr> _logger;
        private readonly AppSoftDbContext _context;
        private readonly CommonDao _commonDao;

        public Task_Prsentr(ILogger<Task_Prsentr> logger, AppSoftDbContext context) {
            _logger = logger;
            _context = context;
