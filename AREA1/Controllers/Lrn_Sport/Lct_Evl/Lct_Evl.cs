...
namespace AREA1.Controllers.Lrn_Sport.Lct_Evl
{
    public class Lct_Evl : Controller {
        private readonly ILogger<Lct_Evl> _logger;
        private readonly AppSoftDbContext _context;
        private readonly CommonDao _commonDao;

        public Lct_Evl(ILogger<Lct_Evl> logger, AppSoftDbContext context) {
            _logger = logger;
            _context = context;
